...
public final class AppointmentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<AppointmentDefinition.Appointment,
      AppointmentDefinition.CreateAppointmentResponse> getCreateAppointmentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateAppointment",
      requestType = AppointmentDefinition.Appointment.class,
      responseType = AppointmentDefinition.CreateAppointmentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<AppointmentDefinition.Appointment,
      AppointmentDefinition.CreateAppointmentResponse> getCreateAppointmentMethod() {
    io.grpc.MethodDescriptor<AppointmentDefinition.Appointment, AppointmentDefinition.CreateAppointmentResponse> getCreateAppointmentMethod;
      ...
      synchronized (AppointmentServiceGrpc.class) {
        if ((getCreateAppointmentMethod = AppointmentServiceGrpc.getCreateAppointmentMethod) == null) {
          AppointmentServiceGrpc.getCreateAppointmentMethod = getCreateAppointmentMethod =
              io.grpc.MethodDescriptor.<AppointmentDefinition.Appointment, AppointmentDefinition.CreateAppointmentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateAppointment"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AppointmentDefinition.Appointment.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AppointmentDefinition.CreateAppointmentResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<AppointmentDefinition.Appointment,
      AppointmentDefinition.ModifyAppointmentResponse> getModifyAppointmentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ModifyAppointment",
      requestType = AppointmentDefinition.Appointment.class,
      responseType = AppointmentDefinition.ModifyAppointmentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<AppointmentDefinition.Appointment,
      AppointmentDefinition.ModifyAppointmentResponse> getModifyAppointmentMethod() {
    io.grpc.MethodDescriptor<AppointmentDefinition.Appointment, AppointmentDefinition.ModifyAppointmentResponse> getModifyAppointmentMethod;
      ...
      synchronized (AppointmentServiceGrpc.class) {
        if ((getModifyAppointmentMethod = AppointmentServiceGrpc.getModifyAppointmentMethod) == null) {
          AppointmentServiceGrpc.getModifyAppointmentMethod = getModifyAppointmentMethod =
              io.grpc.MethodDescriptor.<AppointmentDefinition.Appointment, AppointmentDefinition.ModifyAppointmentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              ...
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AppointmentDefinition.Appointment.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AppointmentDefinition.ModifyAppointmentResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<AppointmentDefinition.CancelAppointmentRequest,
      AppointmentDefinition.CancelAppointmentResponse> getCancelAppointmentMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CancelAppointment",
      requestType = AppointmentDefinition.CancelAppointmentRequest.class,
      responseType = AppointmentDefinition.CancelAppointmentResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<AppointmentDefinition.CancelAppointmentRequest,
      AppointmentDefinition.CancelAppointmentResponse> getCancelAppointmentMethod() {
    io.grpc.MethodDescriptor<AppointmentDefinition.CancelAppointmentRequest, AppointmentDefinition.CancelAppointmentResponse> getCancelAppointmentMethod;
      ...
      synchronized (AppointmentServiceGrpc.class) {
        if ((getCancelAppointmentMethod = AppointmentServiceGrpc.getCancelAppointmentMethod) == null) {
          AppointmentServiceGrpc.getCancelAppointmentMethod = getCancelAppointmentMethod =
              io.grpc.MethodDescriptor.<AppointmentDefinition.CancelAppointmentRequest, AppointmentDefinition.CancelAppointmentResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CancelAppointment"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AppointmentDefinition.CancelAppointmentRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  AppointmentDefinition.CancelAppointmentResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default io.grpc.stub.StreamObserver<AppointmentDefinition.Appointment> createAppointment(
        io.grpc.stub.StreamObserver<AppointmentDefinition.CreateAppointmentResponse> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getCreateAppointmentMethod(), responseObserver);
    }

    /**
     */
    default io.grpc.stub.StreamObserver<AppointmentDefinition.Appointment> modifyAppointment(
        io.grpc.stub.StreamObserver<AppointmentDefinition.ModifyAppointmentResponse> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getModifyAppointmentMethod(), responseObserver);
    }

    /**
     */
    default void cancelAppointment(AppointmentDefinition.CancelAppointmentRequest request,
                                   io.grpc.stub.StreamObserver<AppointmentDefinition.CancelAppointmentResponse> responseObserver) {
  ...
  public static final class AppointmentServiceStub
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<AppointmentDefinition.Appointment> createAppointment(
        io.grpc.stub.StreamObserver<AppointmentDefinition.CreateAppointmentResponse> responseObserver) {
    ...
    /**
     */
    public io.grpc.stub.StreamObserver<AppointmentDefinition.Appointment> modifyAppointment(
        io.grpc.stub.StreamObserver<AppointmentDefinition.ModifyAppointmentResponse> responseObserver) {
      return io.grpc.stub.ClientCalls.asyncClientStreamingCall(
    ...
    /**
     */
    public void cancelAppointment(AppointmentDefinition.CancelAppointmentRequest request,
                                  io.grpc.stub.StreamObserver<AppointmentDefinition.CancelAppointmentResponse> responseObserver) {
  ...
  public static final class AppointmentServiceBlockingStub
    ...
    /**
     */
    public AppointmentDefinition.CancelAppointmentResponse cancelAppointment(AppointmentDefinition.CancelAppointmentRequest request) {
  ...
  public static final class AppointmentServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<AppointmentDefinition.CancelAppointmentResponse> cancelAppointment(
        AppointmentDefinition.CancelAppointmentRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CANCEL_APPOINTMENT:
          serviceImpl.cancelAppointment((AppointmentDefinition.CancelAppointmentRequest) request,
              (io.grpc.stub.StreamObserver<AppointmentDefinition.CancelAppointmentResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              AppointmentDefinition.Appointment,
              AppointmentDefinition.CreateAppointmentResponse>(
        ...
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncClientStreamingCall(
            new MethodHandlers<
              AppointmentDefinition.Appointment,
              AppointmentDefinition.ModifyAppointmentResponse>(
                service, METHODID_MODIFY_APPOINTMENT)))
        .addMethod(
          getCancelAppointmentMethod(),
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              AppointmentDefinition.CancelAppointmentRequest,
              AppointmentDefinition.CancelAppointmentResponse>(
  ...
  private static abstract class AppointmentServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return AppointmentDefinition.getDescriptor();
    }
