...
public final class TriageServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Triage.CheckInTriageProcedureRequest,
      Triage.CheckInTriageProcedureResponse> getCheckInTriageProcedureMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CheckInTriageProcedure",
      requestType = Triage.CheckInTriageProcedureRequest.class,
      responseType = Triage.CheckInTriageProcedureResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<Triage.CheckInTriageProcedureRequest,
      Triage.CheckInTriageProcedureResponse> getCheckInTriageProcedureMethod() {
    io.grpc.MethodDescriptor<Triage.CheckInTriageProcedureRequest, Triage.CheckInTriageProcedureResponse> getCheckInTriageProcedureMethod;
      ...
      synchronized (TriageServiceGrpc.class) {
        if ((getCheckInTriageProcedureMethod = TriageServiceGrpc.getCheckInTriageProcedureMethod) == null) {
          TriageServiceGrpc.getCheckInTriageProcedureMethod = getCheckInTriageProcedureMethod =
              io.grpc.MethodDescriptor.<Triage.CheckInTriageProcedureRequest, Triage.CheckInTriageProcedureResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CheckInTriageProcedure"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Triage.CheckInTriageProcedureRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Triage.CheckInTriageProcedureResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<Triage.SetStatusDiseasePatientRequest,
      Triage.SetStatusDiseasePatientResponse> getSetStatusDiseasePatientMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SetStatusDiseasePatient",
      requestType = Triage.SetStatusDiseasePatientRequest.class,
      responseType = Triage.SetStatusDiseasePatientResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<Triage.SetStatusDiseasePatientRequest,
      Triage.SetStatusDiseasePatientResponse> getSetStatusDiseasePatientMethod() {
    io.grpc.MethodDescriptor<Triage.SetStatusDiseasePatientRequest, Triage.SetStatusDiseasePatientResponse> getSetStatusDiseasePatientMethod;
      ...
      synchronized (TriageServiceGrpc.class) {
        if ((getSetStatusDiseasePatientMethod = TriageServiceGrpc.getSetStatusDiseasePatientMethod) == null) {
          TriageServiceGrpc.getSetStatusDiseasePatientMethod = getSetStatusDiseasePatientMethod =
              io.grpc.MethodDescriptor.<Triage.SetStatusDiseasePatientRequest, Triage.SetStatusDiseasePatientResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SetStatusDiseasePatient"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Triage.SetStatusDiseasePatientRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Triage.SetStatusDiseasePatientResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<Triage.ProcedureStep,
      Triage.AdjustProcedureStepsResponse> getAdjustProcedureStepsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "AdjustProcedureSteps",
      requestType = Triage.ProcedureStep.class,
      responseType = Triage.AdjustProcedureStepsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
  public static io.grpc.MethodDescriptor<Triage.ProcedureStep,
      Triage.AdjustProcedureStepsResponse> getAdjustProcedureStepsMethod() {
    io.grpc.MethodDescriptor<Triage.ProcedureStep, Triage.AdjustProcedureStepsResponse> getAdjustProcedureStepsMethod;
      ...
      synchronized (TriageServiceGrpc.class) {
        if ((getAdjustProcedureStepsMethod = TriageServiceGrpc.getAdjustProcedureStepsMethod) == null) {
          TriageServiceGrpc.getAdjustProcedureStepsMethod = getAdjustProcedureStepsMethod =
              io.grpc.MethodDescriptor.<Triage.ProcedureStep, Triage.AdjustProcedureStepsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.CLIENT_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "AdjustProcedureSteps"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Triage.ProcedureStep.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Triage.AdjustProcedureStepsResponse.getDefaultInstance()))
  ...
  public static abstract class TriageServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void checkInTriageProcedure(Triage.CheckInTriageProcedureRequest request,
        io.grpc.stub.StreamObserver<Triage.CheckInTriageProcedureResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCheckInTriageProcedureMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<Triage.SetStatusDiseasePatientRequest> setStatusDiseasePatient(
        io.grpc.stub.StreamObserver<Triage.SetStatusDiseasePatientResponse> responseObserver) {
      return io.grpc.stub.ServerCalls.asyncUnimplementedStreamingCall(getSetStatusDiseasePatientMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<Triage.ProcedureStep> adjustProcedureSteps(
        io.grpc.stub.StreamObserver<Triage.AdjustProcedureStepsResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                Triage.CheckInTriageProcedureRequest,
                Triage.CheckInTriageProcedureResponse>(
                  this, METHODID_CHECK_IN_TRIAGE_PROCEDURE)))
          .addMethod(
            getSetStatusDiseasePatientMethod(),
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
              new MethodHandlers<
                Triage.SetStatusDiseasePatientRequest,
                Triage.SetStatusDiseasePatientResponse>(
                  this, METHODID_SET_STATUS_DISEASE_PATIENT)))
          .addMethod(
            getAdjustProcedureStepsMethod(),
            io.grpc.stub.ServerCalls.asyncClientStreamingCall(
              new MethodHandlers<
                Triage.ProcedureStep,
                Triage.AdjustProcedureStepsResponse>(
  ...
  public static final class TriageServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<TriageServiceBlockingStub> {
    ...
    /**
     */
    public Triage.CheckInTriageProcedureResponse checkInTriageProcedure(Triage.CheckInTriageProcedureRequest request) {
  ...
  public static final class TriageServiceFutureStub extends io.grpc.stub.AbstractFutureStub<TriageServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Triage.CheckInTriageProcedureResponse> checkInTriageProcedure(
        Triage.CheckInTriageProcedureRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK_IN_TRIAGE_PROCEDURE:
          serviceImpl.checkInTriageProcedure((Triage.CheckInTriageProcedureRequest) request,
              (io.grpc.stub.StreamObserver<Triage.CheckInTriageProcedureResponse>) responseObserver);
          break;
        default:
